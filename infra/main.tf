module "cognito_user_pool_customer" {
  ...
  post_confirmation = module.lambda_sync_customer.lambda_sync_customer_invoke_arn
}

module "cognito_user_pool_internal" {
  source            = "./modules/cognito_user_pool_internal"
  project_name      = var.project_name
  post_confirmation = module.lambda_sync_internal.lambda_sync_internal_invoke_arn
}
